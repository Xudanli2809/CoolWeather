package com.example.jootu.coolweather.service;
...
import com.example.jootu.coolweather.WeatherActivity;
...
public class AutoUpdateService extends Service {
    ...
    public void updateBingPic(){
        ...
        HttpUtil.sendOkHttpRequest(requestBingPic, new Callback() {//向上述地址发出请求，服务器会将信息已json格式返回
            @Override
            public void onFailure(Call call, IOException e) {
                e.printStackTrace();
            }
